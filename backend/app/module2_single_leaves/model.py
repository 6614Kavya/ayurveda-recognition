...
def get_health_artifacts():
    """
    Loads latest uploaded artifacts for Module 2 Health Assessment.
    """
    artifacts = {}

    # Stage 1: Healthy vs Damaged Classifier
    stage1_pipeline_path = os.path.join(HEALTH_MODEL_DIR, "stage1_healthy_vs_damaged_classifier_pipeline.pkl")
